            ...
            <ContentSection
              ...
              columnTwo={
                  <div className="experience-description-text-wrapper" >
                    ...
                    <br/>
                    <p className="experience-description-text">
                      As far as technical specifics, I conducted transfer learning on a pre-trained RetinaNet model, utilizing Pytorch and Juptyer Notebook, hosted on a Google Cloud Virtual Machine. Specifically, we used Facebook AI's Detectron2 object detection library, and used custom labeled data from Aryeo's own user data base to refine the model. In addition, I improved the system's mean Average Precition (mAP) by over 10%, by introducing both model ensembling (combining results of different models), and pseudo-labeling (using the model to generate more training data). I used streamlit to create a UI for the model, allowing users to upload photos of their homes and see labeled bounding boxes around various household amenities. I also had the opportunity to present my work to a pannel of google engineers, the Duke Machine Learning community, and the Aryeo team. Overall, this was an awesome experience that grew my interest in ML.
                    </p>
                    <br/>
            ...
            <ContentSection
              ...
              columnTwo={
                  <div className="experience-description-text-wrapper" >
                    ...
                    <br/>
                    <p className="experience-description-text">
                      For summer 2021, I took on an even larger role, by leading the entire program. This time around I sourced all projects, led client calls, interviewed all students and built out a thorough airtable platform. I helped raise the salary of each intern from 1 to 4 thousand dollars, and sorted out all payment, legal, and other logistical issues. In total, we've supplied our students with over 80 thousand dollars worth of stipends. Running the Phoenix Project has been an incredible experience !
                    </p>
                    <br/>
                    <p className="experience-description-text bolded-text">
